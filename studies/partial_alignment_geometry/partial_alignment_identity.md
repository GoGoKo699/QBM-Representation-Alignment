...
\qquad
I_G(\theta)=\operatorname{Cov}_{p_\theta}(F_G,F_G).
\]
...
\[
r_G(\theta)=\operatorname{Cov}_{p_\theta}(F_G,R_G).
\]
...
=-\operatorname{Cov}(F_{G,j},C).
\]

Substitute the cost decomposition and use bilinearity of covariance:

\[
\operatorname{Cov}(F_G,C)
=I_Gc_G+\operatorname{Cov}(F_G,R_G).
\]
...
\[
\widehat I_G
=\widehat{\operatorname{Cov}}(F_G,F_G),
\qquad
\widehat r_G
=\widehat{\operatorname{Cov}}(F_G,R_G).
\]
...
=P_{\operatorname{range}(\widehat I_G)}c_G
