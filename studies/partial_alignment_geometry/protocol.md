...
\[
0.9\widehat I+0.1\operatorname{diag}(\widehat I)
...
\[
\left[
0.95\widehat I+0.05\operatorname{diag}(\widehat I)
+10^{-3}\bar I_{\rm diag}\,\mathbb I
\right]d=-\widehat g.
\]
...
1. estimate the scalar natural step along \(c_G\),
   ...
   {c_G^{\mathsf T}\widehat I c_G+10^{-3}\overline I_{\rm diag}\|c_G\|^2};
   \]
...
Unlike the fully aligned the aligned finite-sample study method, the scalar step is not forced positive because the projected target direction need not be a descent direction.
