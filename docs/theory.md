...
Along $\theta\mapsto\theta+\beta c$,

$$
\frac{dE}{d\beta}=-\mathrm{Var}(C)\le0.
$$
...
For a unique ground state with energy $E_0$ and spectral gap $\gamma$, every density operator satisfies

$$
\Delta E=\mathrm{Tr}(H\rho)-E_0
\ge\gamma(1-p_\star).
$$
...
The confirmatory success criterion $\Delta E/\gamma\le 0.1$ certifies $p_\star\ge 0.9$.
